...
<div id="basic-home-info">
    <ul>
        ...
        <?php }?>
        <?php if (!empty($this->item->short_sale)) { ?>
            <li>
                <b><?php echo JText::_('COM_VPPI_LBL_SHORT_SALE'); ?>:</b>  <?php echo $this->item->short_sale; ?>
            </li>
        <?php }?>
        <?php if (!empty($this->item->bank_owned)) { ?>
            <li>
                <b><?php echo JText::_('COM_VPPI_LBL_BANK_OWNED'); ?>:</b>  <?php echo $this->item->bank_owned; ?>
            </li>
        <?php }?>
