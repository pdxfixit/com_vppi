...
foreach ($this->items as $item) {
    if (!empty($this->posters['slide'][$item->id]) && $item->state && $item->featured) {
        $html .= '<a href="' . JRoute::_('index.php?option=com_vppi&view=home&layout=default&id=' . $item->slug) . '" class="cycle-slide" data-cycle-title="' . $item->name . '" data-cycle-desc="' . $item->city . ',&nbsp;' . $item->state_prov . '&nbsp;&nbsp;' . $item->zip_code . '">';
